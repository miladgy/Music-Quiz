    ...
    render() {
        return (
            <div className="waiting-room">
                ...
                <h3 className="waiting-room__header__h3 header__tag">You will play: </h3>
                <p className="paragraph waiting-room__paragraph">{this.beautifyGameMode()}</p>

                <h3 className="waiting-room__header__h3 header__tag">Participants:</h3>
                <h4 className="waiting-room__header__h4 header__tag">Your host:</h4>
                ...
                <h4 className="waiting-room__header__h4 header__tag">Players:</h4>
                {this.state.users.filter(user => !user.isHost).map(user =>
                    <p
                ...
                {this.state.users.find(user => this.props.socket.id === user.id && user.isHost)
                    ? <button
                        ...
                        onClick={this.startGame}>START QUIZ</button>
